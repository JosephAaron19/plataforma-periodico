  ...
  return (
    <div className="space-y-6 text-slate-800 p-6 min-h-screen bg-[#0b1329] bg-gradient-to-br from-[#0b1329] via-[#101b3b] to-[#070b1a] relative overflow-hidden">
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-[3/4] bg-slate-950 overflow-hidden">
                  ...
                  {/* Hover Quick Action */}
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 bg-slate-950/40 backdrop-blur-xs">
      ...
      {isReaderOpen && selectedEdition && (
        ...
        >
          {/* Header Toolbar */}
          <div className="bg-[#0b1329]/90 border-b border-white/10 px-6 py-4 flex items-center justify-between flex-shrink-0 backdrop-blur-md">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              {/* Zoom Controls */}
              <div className="flex bg-slate-900 border border-white/10 rounded-xl p-1 text-slate-400 items-center">
                <button 
              ...
              <button 
                ...
                className="p-2.5 bg-slate-900 border border-white/10 hover:text-white text-slate-400 rounded-xl transition-all"
          ...
          <div className="flex-grow flex items-center justify-between p-4 relative overflow-hidden bg-[#050914] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#0d162d] via-[#050914] to-[#02050c]">
            ...
            <button 
              ...
              className="absolute left-6 z-40 bg-slate-900/80 hover:bg-slate-800/90 text-slate-300 hover:text-white border border-white/10 hover:border-sky-500/30 p-4 rounded-full disabled:opacity-10 transition-all shadow-2xl disabled:pointer-events-none hover:scale-105"
            >
            ...
            <button 
              ...
              className="absolute right-6 z-40 bg-slate-900/80 hover:bg-slate-800/90 text-slate-300 hover:text-white border border-white/10 hover:border-sky-500/30 p-4 rounded-full disabled:opacity-10 transition-all shadow-2xl disabled:pointer-events-none hover:scale-105"
            >
